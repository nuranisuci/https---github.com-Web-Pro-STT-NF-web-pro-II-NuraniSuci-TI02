    ...
    <div class="container card ">
        ...
        <form method="POST" style="margin-left : 30%;">
            <div class="form-group row">
                ...
                <div class="col-5">
                    <input id="nim" name="nim" placeholder="0211" type="text" class="form-control">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-5">
                    <input id="nilai" name="nilai" placeholder="89" type="text" class="form-control">
                </div>
            </div>
            <div class="form-group row">
        ...
        $data_siswa = new NilaiMahasiswa(89, "Data Warehouse", 0211);
        ...
        <div class="row">
            <div class="col-12 bg-light pt-3">
                <p>Lab Pemrograman Web Lanjutan
                <p>
