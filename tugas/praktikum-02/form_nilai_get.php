...
<body>
    <div class="container card">
        ...
        <div class="row">
            <div class="col-12">
                <form method="GET" action="form_nilai_get.php">
                ...
                <?php
                $proses = isset ($_GET['proses']);
                $nama_lengkap = isset ($_GET['nama']);
                $mata_kuliah = isset ($_GET['matkul']);
                $nilai_uts = isset ($_GET['nilai_uts']);
                $nilai_uas = isset ($_GET['nilai_uas']);
                $nilai_tugas = isset ($_GET['nilai_tugas']);
